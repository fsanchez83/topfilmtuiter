...
id_lista = dataConfig['General']['id_lista']
lista_usrs_ruta = dataConfig['Resultados']['resultados_base']+id_lista+'/Procesamiento/usuarios'+id_lista+'.csv'
lista_usrs = pd.read_csv(lista_usrs_ruta, sep=';')
usuarios_totales = lista_usrs.drop_duplicates(subset=['Usuarios'])
print('Usuarios totales: ',len(usuarios_totales))
usuarios_totales.to_csv(lista_usrs_ruta, sep=';', index=False)
